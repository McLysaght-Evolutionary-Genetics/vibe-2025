...
<section class="relative overflow-hidden py-32">
  ...
  <div class="relative z-10 container mx-auto">
    <div class="mx-auto flex max-w-5xl flex-col items-center">
      <div>
        <p class="mx-auto mb-4 max-w-5xl text-justify lg:text-2xl"><b>Symposia</b></p>
        <p class="mx-auto mb-1 max-w-5xl text-justify lg:text-xl"><b>Medical Genomics</b></p>
        <p class="mx-auto mb-4 max-w-5xl text-justify lg:text-xl">
          Caner genomics, Disease genetics, Transcriptomics and methylomics of disease, Somatic evolution
        </p>
        <p class="mx-auto mb-1 max-w-5xl text-justify lg:text-xl"><b>Evolution and Population Genetics</b></p>
        <p class="mx-auto mb-4 max-w-5xl text-justify lg:text-xl">
          Molecular evolution, phylogenetics and comparative genomics, Ancient DNA, Metagenomics and biodiversity
        </p>
        <p class="mx-auto mb-1 max-w-5xl text-justify lg:text-xl"><b>Methods and Tools</b></p>
        <p class="mx-auto mb-4 max-w-5xl text-justify lg:text-xl">
          New algorithms, New tools and pipelines, Evaluation / Benchmarking / Documentation of existing tools
        </p>
        <p class="mx-auto mb-1 max-w-5xl text-justify lg:text-xl"><b>Computational Biology beyond Genomics</b></p>
        <p class="mx-auto mb-8 max-w-5xl text-justify lg:text-xl">
          Neuroinformatics, Metabolomics, Image analysis for biology, Protein folding and protein-protein interactions,
          Systems biology and cell modelling
        </p>
        <p class="mx-auto mb-4 max-w-5xl text-justify lg:text-2xl"><b><i>Full program to follow</i></b></p>
      </div>
    </div>
  </div>
</section>
